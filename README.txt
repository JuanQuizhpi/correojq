...
a persistence unit "correojqPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "correojq/pom.xml":
...
artifact ("correojq.war") is already built. You can build
